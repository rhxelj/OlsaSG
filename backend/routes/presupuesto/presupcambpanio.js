        ...
        conexion.query(ojales, function (err, result) {
          if (err) {
            ...
            while (j < 4) {
              ...
              console.log('(valorhora / 60 * 21 ) ', (valorhora))
              console.log('(valorhora / 60 ) ', (valorhora / 60))
              console.log('(valorhora / 60 * 21 ) ', (valorhora / 60 * 21))
              console.log('(valorhora / 60 * 21 * anchoreal) ', (valorhora / 60 * 21 * anchoreal))
              console.log('(60 * 21 ) ', (60 * 21))
              console.log('(21 ) ', (21 * anchoreal * 2))
